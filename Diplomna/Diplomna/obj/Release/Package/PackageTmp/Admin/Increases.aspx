...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Companies_ID,Risk_ID" DataSourceID="SqlDataSourceIncreases">
        <Columns>
            ...
            <asp:TemplateField HeaderText="PosNeg" SortExpression="PosNeg">
                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="TypeValue" SortExpression="TypeValue">
                <EditItemTemplate>
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    ...
                    <asp:SqlDataSource runat="server" ID="SqlDataSourceRisks" ConnectionString='<%$ ConnectionStrings:DiplomnaConnectionString %>' SelectCommand="SELECT ID, Name FROM Risk WHERE (Status = 1) AND (ID NOT IN (SELECT Risk_ID FROM Increases AS Increases_1 WHERE (Companies_ID = @CompanyID)))">
                        <SelectParameters>
