    ...
    <div style="width: 100%; height: auto; overflow: auto;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSourceAllCompanies" AllowPaging="True" AllowSorting="True">
            <Columns>
                ...
                <asp:BoundField DataField="WebAddress" HeaderText="WebAddress" SortExpression="WebAddress"></asp:BoundField>
    ...
    <div style="margin-top: 20px;">
        ...
        <table border="0">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxPhone" runat="server" MaxLength="9" CssClass="DropDown" TextMode="Phone"></asp:TextBox></td>
