...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSourceAllClauses" AllowSorting="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowPaging="True">
        <Columns>
            ...
            <asp:BoundField DataField="MinNumber" HeaderText="Минимално допустимо число" SortExpression="MinNumber">
            <HeaderStyle Font-Bold="True" Font-Size="Small" />
            <ItemStyle Font-Bold="False" Font-Size="Small" HorizontalAlign="Right" />
            </asp:BoundField>
            <asp:BoundField DataField="MaxNumber" HeaderText="Максимално допустимо число" SortExpression="MaxNumber">
            <HeaderStyle Font-Bold="True" Font-Size="Small" />
