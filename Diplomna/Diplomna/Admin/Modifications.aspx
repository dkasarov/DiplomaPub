<%@ Page Title="Модификации" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Modifications.aspx.cs" Inherits="Diplomna.Admin.Models" UnobtrusiveValidationMode="None" EnableEventValidation="false" %>
    ...
    <div style="overflow: scroll; width: 100%; height: auto;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceAllModif" AllowPaging="True" AllowSorting="True" DataKeyNames="ID">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Модел" SortExpression="Models_ID">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSourceEditModel" DataTextField='BothName' DataValueField="ID" SelectedValue='<%# Bind("Models_ID") %>'>
                        </asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDataSourceEditModel" runat="server" ConnectionString="<%$ ConnectionStrings:DiplomnaConnectionString %>" SelectCommand="SELECT Models.ID, Models.Name, CONCAT(Brands.Name, ' > ', Models.Name)  AS BothName FROM Models INNER JOIN Brands ON Models.Brands_ID = Brands.ID WHERE (Models.Status = 1) ORDER BY Brands.ID"></asp:SqlDataSource>
                    </EditItemTemplate>
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="Name" HeaderText="Модификация" SortExpression="Name">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
                <asp:BoundField DataField="EngineVolume" HeaderText="Кубатура" SortExpression="EngineVolume">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
                <asp:BoundField DataField="EnginePower" HeaderText="Мощност" SortExpression="EnginePower">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
                <asp:TemplateField HeaderText="Гориво" SortExpression="EngineFuel">
                    <EditItemTemplate>
                ...
                <asp:BoundField DataField="Doors" HeaderText="Брой врати" SortExpression="Doors">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
                <asp:BoundField DataField="ProduceFrom" HeaderText="Произвеждан от" SortExpression="ProduceFrom">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
                <asp:BoundField DataField="ProduceTo" HeaderText="Произвеждан до" SortExpression="ProduceTo">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
                <asp:BoundField DataField="InsuranceValue" HeaderText="Застрахователна стойност" SortExpression="InsuranceValue">
                <HeaderStyle Font-Bold="True" Font-Size="Small" />
                <ItemStyle Font-Size="Small" />
                </asp:BoundField>
    ...
    <div style="margin-top: 20px;">
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownListBrand" runat="server" CssClass="DropDown"></asp:DropDownList>
                    <ajaxToolkit:CascadingDropDown ID="CDD1" runat="server"
                    TargetControlID="DropDownListBrand"
                    Category="Brands"
                    LoadingText="[Зареждане...]"
                    ServicePath="~/Services/Modification.asmx"
            ...
            <tr>
                <td><p>Модел</p></td>
                <td>
                    <asp:DropDownList ID="DropDownListModel" runat="server" CssClass="DropDown"></asp:DropDownList>
